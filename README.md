...
This project focuses on classifying the number of people in a room using delay-Doppler signal representations. The problem is formulated as an image classification task, where each sample is a 2D snapshot derived from 60 GHz signal reflections.
